...
function App() {
  ...
  return (
    <div className ="w-[100vw] h-[100vh]  flex justify-center items-center bg-[#344151] flex-col gap-10" >
      ...
      <div className = "bg-white flex justify-center gap-12 py-3 rounded-sm flex-row text-[25px] text-[#344151]">
      ...
      <button onClick ={resetHandler} className="w-30 bg-[#0398d4] text-white px-5 rounded-sm text-lg ">
        Reset
      </button>
    </div>
  );
